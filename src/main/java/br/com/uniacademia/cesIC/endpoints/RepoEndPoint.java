...
public interface RepoEndPoint {
    ...
    Optional<RepoInfo> findRepoInfo(@RequestParam("user") String user, @RequestParam("repo") String repo);
    ...
    @GetMapping(produces = "application/json", value = "/repos/{user}/{repo}/contributors?sha=master&per_page=100&page={pages}")
    List<Contributor> findAllContributors(@RequestParam("user") String user, @RequestParam("repo") String repo,
	    @RequestParam("pages") int pages);
